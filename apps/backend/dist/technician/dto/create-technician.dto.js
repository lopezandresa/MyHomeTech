...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID del usuario asociado', example: 1 }),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], CreateTechnicianDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Especialidad del técnico' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateTechnicianDto.prototype, "specialization", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Años de experiencia', minimum: 0 }),
    (0, class_validator_1.IsInt)(),
